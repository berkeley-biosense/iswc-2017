...
We analyzed the EEG signals collected during the tasks using a support vector classifier (SVC). Since past work has shown that classification tasks in EEG-based BCI are linear \underline{Garrett2003a}, we used XGBoost, a tool for logistic linear classification \underline{Chen2016}.
