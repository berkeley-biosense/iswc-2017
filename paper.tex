...
\begin{center}
\begin{tabular}{lrr}
 \textbf{Training Scheme} & \textbf{FAR} & \textbf{FRR}\\
\hline
...
\end{tabular}
\end{center}
\caption{Mean FAR and FRR for all participants and passthoughts across three different training schemes.}
\label{tab:compare}
\end{table}
